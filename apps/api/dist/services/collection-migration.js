...
export async function assignLegacyCardsToCollection() {
    ...
    const collection = await CardCollectionModel.findOneAndUpdate({ normalizedName: normalizeCollectionName(legacyCollectionName) }, {
        $setOnInsert: {
